[![Passing tests on master](https://travis-ci.org/oliverlorenz/repo-baseline-json-check-schema.svg?branch=master)](https://travis-ci.org/oliverlorenz/repo-baseline-json-check-schema)
